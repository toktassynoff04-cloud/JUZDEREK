(() => {
  ...
  window.renderChrono=function(){
    ...
    stage.innerHTML=`<div class="stage-top"><div class="stage-title"><h2>Хронология</h2><p>Оқиғаларды реттілігі бойынша орналастырыңыз.</p></div><span class="step-counter">5 оқиға</span></div><div class="progress-line"><span style="width:0%"></span></div><div class="chrono-game"><div class="chrono-help"><span class="chrono-help-icon">1–5</span><span>Әр оқиғаға берілген санға қара. Ең ерте оқиғадан ең кейінгісіне дейінгі дұрыс реттілікті төмендегі жауаптардан таңда.</span></div><div class="chrono-list">${numbered.map(f=>`<div class="chrono-item"><span class="chrono-source-num">${f.sourceNum}</span><span class="chrono-copy">${f.event}</span></div>`).join('')}</div><div class="chrono-choice-title">Дұрыс реттілікті таңда</div><div class="chrono-options">${options.map((o,i)=>`<button class="chrono-option" data-seq="${o.join(',')}"><span class="chrono-option-letter">${String.fromCharCode(65+i)}</span><span class="chrono-option-seq">${seqText(o)}</span></button>`).join('')}</div><div class="chrono-result" id="chronoResult"></div></div>`;
